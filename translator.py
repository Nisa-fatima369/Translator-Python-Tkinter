...
# icon
image_icon= PhotoImage(file="Translator-Python-Tkinter/googletranslator.png")
root.iconphoto(False,image_icon)

#arrow
arrow_image= PhotoImage(file= "Translator-Python-Tkinter/arrow.png")
...
#irst ComboBox
combo1= ttk.Combobox(root, values=languageV, font= "Roboto", state= "r")
...
#Second ComboBox
combo2= ttk.Combobox(root, values=languageV, font= "Roboto", state= "r")
